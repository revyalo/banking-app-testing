...
- Nombre de la aplicación en Azure: `banking-app-production`.
- URL pública: https://banking-app-production.azurewebsites.net
...
- El despliegue usa el nombre de aplicación solicitado en el enunciado: `banking-app-production`.
